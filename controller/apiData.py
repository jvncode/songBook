...
class apiConnect:
    ...
    def getMusixMatch(self):
        ...
        data = musixmatch.track_search(q_artist="", q_track=self.query, page_size=10, page=1, s_track_rating='desc')
        return data

    def getLastFM(self):
        url = 'https://ws.audioscrobbler.com/2.0/?method=track.search&track=' + self.query + '&api_key=' + LASTFM_KEY + '&format=json'
